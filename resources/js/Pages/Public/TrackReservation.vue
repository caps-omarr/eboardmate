                ...
                <div class="row justify-content-center mb-4">
                    <div class="col-lg-9">
                        ...
                        >
                            <Link
                                href="/"
                                class="btn btn-outline-secondary rounded-pill fw-semibold px-3 py-2 shadow-sm d-inline-flex align-items-center gap-1"
                            >
                        ...
                        <div class="text-center">
                            ...
                            <p class="ebm-muted mb-0">
                                Enter your reference code and email address to
                ...
                <div class="row justify-content-center g-4">
                    <div class="col-lg-5">
                        <div class="ebm-card p-4 p-md-5">
                            <h2 class="h4 fw-bold mb-3">Tracking Form</h2>
                            ...
                            <form @submit.prevent="submitTracking">
                                ...
                                <button
                                    type="submit"
                                    class="btn btn-ebm-primary w-100 rounded-pill py-2 fw-bold shadow-sm"
                                ...
                                >
                                    ...
                                    <span v-else> Track Reservation </span>
                                </button>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7">
                        <div v-if="trackingResult" class="ebm-card p-4 p-md-5">
                            <div
                            ...
                            >
                                ...
                                This reservation is no longer active. You may
                                submit a new reservation for this boarding house
                            ...
                            <div class="receipt-details">
                                <div class="receipt-row">
                                    ...
                                    <strong>{{
                                        trackingResult.boarding_house_name
                                    }}</strong>
                                </div>
                                ...
                                <div class="receipt-row">
                                    ...
                                    <strong>{{
                                        trackingResult.preferred_move_in_date
                                    }}</strong>
                                </div>
                            ...
                            >
                                This reservation no longer blocks you from
                                applying again. You may submit a new reservation
                                if the boarding house still has available rooms
                                or bedspaces.
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <p class="ebm-muted mb-0 text-center">
                                Your reservation details will appear here after
                                you enter a valid reference code and email
                                address.
                            </p>
                        </div>
                    </div>
