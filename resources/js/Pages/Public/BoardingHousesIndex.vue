...
<template>
    <PublicLayout>
        ...
        <!-- 🚀 FIX: Changed background to tertiary so the white cards pop natively -->
        <section class="py-4 py-md-5 bg-body-tertiary min-vh-100">
            <div class="container-fluid px-3 px-md-4 max-w-desktop mx-auto">
                
                <!-- Native App-Style Header -->
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-end mb-4 gap-3">
                    <div>
                        <span class="badge rounded-pill border border-success-subtle bg-success bg-opacity-10 text-success shadow-sm mb-2 px-3 py-2">
                            Property Listings
                        </span>
...
/* Native App-Style Card Animations */
