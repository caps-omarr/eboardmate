            ...
            return BoardingHouse::with(['photos' => function ($query) {
                ...
                ->map(function ($house) {
                    ...
                    return [
                        ...
                        'water_billing_details' => $house->water_billing_details,
                        'electricity_billing_details' => $house->electricity_billing_details,
                        'is_full' => $house->isFull(),
                        'business_permit_url' => $house->business_permit_url,
                        'is_permit_processing' => (bool) $house->is_permit_processing,
                        'permit_processing_notes' => $house->permit_processing_notes,
                        'house_rules_image_url' => $house->house_rules_image_url,
